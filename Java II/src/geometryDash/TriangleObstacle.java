...
public class TriangleObstacle extends GeometryObject{
	...
	Rectangle r2 = new Rectangle(x + (int)(width/2) - (int)(0.5 * width/5), y, (int)(width/5), (int)(3*height/4));
...
//		g.drawRect(x, y + height - (int)(height/4), width, (int)(height/4));
//		g.drawRect(x + (int)(width/2) - (int)(0.5 * width/5), y, (int)(width/5), (int)(3*height/4));
//	}
	public int getType() {
		return 1;
	}
